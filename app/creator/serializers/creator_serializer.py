...
class CreatorProfileDisplaySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Creator
        fields = ['id', 'email', 'first_name', 'last_name', 'username', 'profile_image', 'description','key_skill', 'other_skills', 'instagram_url', 'youtube_url', 'facebook_url', 'creator_website_url', 'total_rating', 'creator_reviews', 'affiliation_link','is_fav']
