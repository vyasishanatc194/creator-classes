...
from .models import User, CreatorReview, ClassReview, SessionBooking, StreamBooking, FavouriteCreator, FavouriteClass,TransactionDetail, UserKeyword, Notification, CountryField
...
admin.site.register(CountryField)
